...
input_box = tk.Text(root, height=3, width=50, bg="#65ceeb", fg="black", insertbackground="white", font=("Arial", 12))
...
listbox = tk.Listbox(root, height=15, width=50, bg="#1c031b", fg="white", selectbackground="#7289da", font=("Arial", 12))
